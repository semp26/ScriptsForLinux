...
# run_benchmarks.sh
#
# This script installs the required packages on Ubuntu Server 24.04,
# then collects basic system info, runs disk I/O tests with fio,
# network tests with iperf3, and a Geekbench 5 benchmark.
# A report similar to your sample will be created in a timestamped file.
#
...
# --- Install Dependencies for Ubuntu Server 24.04 ---
echo "Updating package lists and installing dependencies..."
apt update
apt install -y fio iperf3 jq wget tar

# Geekbench 5 is not available in the Ubuntu repos.
# We'll download and install Geekbench 5 CLI if it is not already installed.
